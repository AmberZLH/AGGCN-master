...
from models import LSTM, ASCNN, AGGCN
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', default='aggcn', type=str)
    ...
    input_colses = {
        ...
        'aggcn': ['text_indices', 'aspect_indices', 'left_indices', 'dependency_graph'],
        'agtcn': ['text_indices', 'aspect_indices', 'left_indices', 'dependency_graph'],
    }
    initializers = {
